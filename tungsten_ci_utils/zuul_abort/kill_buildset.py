...
def kill_job(arg):
    ...
    cmd = ["ssh", "-i", ssh_key_path, "-l", "zuul", worker_address]
    try:
        ...
        ret = cpe.returncode
    print("Command {} returned code {}, output: {}".format(cmd, ret, output))
    return ret == 0
...
def main():
    ...
    r = Retrier(ConstantRetryStrategy(10))
    r.retry_call(kill_buildset, [buildset_id], max_tries=15)
